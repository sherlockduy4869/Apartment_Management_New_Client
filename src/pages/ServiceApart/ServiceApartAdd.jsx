...
const ServiceApartAdd = () => {
  ...
  const addingApart = (e) => {
    ...
    const url_add = "https://api.betterhomes.site/public/api/v1/serviceapart"
    ...
    formData.append("purpose", "service_apart")
...
export default ServiceApartAdd