...
const SliderEdit = () => {
  ...
  const fetchSlider = async () =>{
    const res = await fetch('http://localhost/admin_api/public/api/v1/sliders/'+id)
  ...
  const addingSlider = () => {
      ...
      axios.post(url, formData)
          .then(res => {
              setErrorImage("")
              setAddSuccess("Edit slider successfully !")
          })
          .catch(error => {
      ...
      <form class="w-full max-w-sm">
        <div class="md:flex md:items-center mb-6">
          ...
          <div class="md:w-2/3">
            ...
            type="file" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500"/>
        ...
        <div class="md:flex md:items-center mb-6">
          ...
          <div class="md:w-2/3">
            <input value={slider["note_slider"]} onChange={(e) => setNote(e.target.value)}
            type="text" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500"/>
          </div>
        </div>
        <div class="md:flex md:items-center mb-6">
          <div class="md:w-1/3">
